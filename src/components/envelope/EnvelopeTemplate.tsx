  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', paddingLeft: '0mm', marginTop: '0.5mm' }}>
          ...
          <span style={{
            ...
            fontSize: upperZipFs, fontWeight: 'bold', letterSpacing: '0.17em',
          }}>
            {zip || r.zip}
          </span>
        </div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: lowerZipFs, fontWeight: 'bold', letterSpacing: '0.24em', marginLeft: '38mm', marginTop: '22mm' }}>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', paddingLeft: '0mm', marginTop: '0.5mm' }}>
          ...
          <span style={{
            ...
            fontSize: upperZipFs, fontWeight: 'bold', letterSpacing: '0.08em',
          }}>
            {zip || r.zip}
          </span>
        </div>
      ...
      <div style={{
        ...
        {addrLine2 && <div>{addrLine2}</div>}
        <div>ที่ {r.book_no}&nbsp;&nbsp;&nbsp;{r.owner}</div>
        <div style={{ fontSize: lowerZipFs, fontWeight: 'bold',paddingLeft: '38mm', letterSpacing: '0.18em', marginTop: '17mm' }}>
          {info.office_zip ? formatZipSpaced(info.office_zip) : (zip || r.zip)}
        </div>
      </div>
