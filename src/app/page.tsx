...
function QueuePage({ setPage, addToast, currentUser }:any) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 animate-fadeIn">
      ...
      {/* Operation Manual PDF Link */}
      <div className="glass-card p-4 mb-6 flex items-center gap-4">
        <span className="material-icons text-primary text-2xl">menu_book</span>
        <div className="flex-1">
          <p className="font-bold text-secondary dark:text-white text-sm">คู่มือปฏิบัติงาน</p>
          <p className="text-xs text-slate-400 mt-0.5">ขั้นตอนการพิมพ์หนังสือ, ใส่เลขแท็ก และการตั้งค่าเครื่องปริ้น</p>
        </div>
        <a
